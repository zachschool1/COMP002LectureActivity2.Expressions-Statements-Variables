...
let myGreeting = "This is my greeting!";
...
//pi = 2; //error, can't change pi as it is a const
...
let minNum = Math.min(pi,myNumber); //result would be 3.14, pi since it is lower than what i set myNumber to, 21.
